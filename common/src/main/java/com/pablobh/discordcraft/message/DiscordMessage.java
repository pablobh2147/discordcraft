    ...
    public DiscordMessage(@Nonnull ConfigurationSection config) {
        if (config.isString("")) {
            ...
            if (config.contains("embed")) {
                ConfigurationSection embedSection = config.getSection("embed");
    ...
    private static class EmbedData {
        ...
        EmbedData(@Nonnull ConfigurationSection config) {
            ...
            if (config.contains("author")) {
                this.author = new AuthorData(config.getSection("author"));
            }

            if (config.contains("footer")) {
                this.footer = new FooterData(config.getSection("footer"));
            }

            if (config.contains("fields") && config.isList("fields")) {
